...
int bd=int(random(20));
  ...
  if(sel==0) {
  digitalWrite(3, HIGH); }
  else if(sel==1){ digitalWrite(1, HIGH);  }
  else if(sel==2){ digitalWrite(2, HIGH);  }
  else if(sel==3){ digitalWrite(3,LOW);  }
  else if(sel==4){ digitalWrite(1, LOW);  }
  else if(sel==5){ digitalWrite(2, LOW);  }
